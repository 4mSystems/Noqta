...
public class Constants {
    ...
    public static final int IS_POST_SHARED = 1;
    ...
    public static final String RENEW_SUBSCRIPTIONS = "RENEW_SUBSCRIPTIONS";

    public static final String CANCEL_REASONSE = "CANCEL_REASONSE";
