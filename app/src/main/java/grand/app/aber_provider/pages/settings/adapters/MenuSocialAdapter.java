...
import grand.app.aber_provider.databinding.ItemSocialMenuBinding;
...
public class MenuSocialAdapter extends RecyclerView.Adapter<MenuSocialAdapter.MenuView> {
    List<SocialMediaData> socialMediaDataList;
    private Context context;

    public MenuSocialAdapter() {
    ...
    public MenuView onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_social_menu,
                parent, false);
    ...
    public class MenuView extends RecyclerView.ViewHolder {
        public ItemSocialMenuBinding itemMenuBinding;
