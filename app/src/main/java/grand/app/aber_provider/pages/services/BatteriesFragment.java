...
import grand.app.aber_provider.databinding.FragmentBatteriesBinding;
...
public class BatteriesFragment extends BaseFragment {
    ...
    FragmentBatteriesBinding binding;

    @Nullable
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_batteries, container, false);
