...
import grand.app.aber_provider.databinding.FragmentAberBoxBinding;
...
public class AberBoxFragment extends BaseFragment {
    @Inject
    ServicesViewModels viewModel;
    FragmentAberBoxBinding binding;

    @Nullable
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_aber_box, container, false);
