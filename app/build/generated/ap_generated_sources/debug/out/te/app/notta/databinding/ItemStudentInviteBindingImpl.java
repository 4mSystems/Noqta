...
public class ItemStudentInviteBindingImpl extends ItemStudentInviteBinding implements te.app.notta.generated.callback.OnCheckedChangeListener.Listener {
    ...
    // variables
    @Nullable
    private final android.widget.CompoundButton.OnCheckedChangeListener mCallback80;
    // values
    // listeners
    ...
    private ItemStudentInviteBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback80 = new te.app.notta.generated.callback.OnCheckedChangeListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setListeners(this.checkbox, mCallback80, (androidx.databinding.InverseBindingListener)null);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1
