...
public class FragmentAddGiftBindingImpl extends FragmentAddGiftBinding implements te.app.notta.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.input_gift_name, 5);
        sViewsWithIds.put(R.id.auto, 6);
        sViewsWithIds.put(R.id.input_group_desc, 7);
        sViewsWithIds.put(R.id.input_gift_image, 8);
        sViewsWithIds.put(R.id.input_points, 9);
        sViewsWithIds.put(R.id.incrementalViewStudentCount, 10);
    }
    // views
    @NonNull
