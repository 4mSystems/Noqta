...
public class FragmentGroupDetailsBindingImpl extends FragmentGroupDetailsBinding implements te.app.notta.generated.callback.OnClickListener.Listener {
    ...
    /* flag mapping
        ...
        flag 7 (0x8L): viewmodel.groupDetails.teacher.id == viewmodel.userData.id ? true : viewmodel.groupDetails.member == 1 ? View.VISIBLE : View.GONE
        ...
        flag 9 (0xaL): viewmodel.groupDetails.joinSent == 1 ? @android:drawable/ic_request_waiting : @android:drawable/ic_icon_awesome_user_plus
        ...
        flag 11 (0xcL): viewmodel.groupDetails.teacher.id != viewmodel.userData.id ? viewmodel.groupDetails.member == 0 : false ? View.VISIBLE : View.GONE
        ...
        flag 13 (0xeL): viewmodel.groupDetails.member == 1 ? View.VISIBLE : viewmodel.groupDetails.teacher.id == viewmodel.userData.id ? View.GONE : View.GONE
        ...
        flag 17 (0x12L): viewmodel.groupDetails.teacher.id != viewmodel.userData.id ? viewmodel.groupDetails.member == 0 : false
        flag 18 (0x13L): viewmodel.groupDetails.teacher.id == viewmodel.userData.id ? View.GONE : View.GONE
        flag 19 (0x14L): viewmodel.groupDetails.teacher.id == viewmodel.userData.id ? View.GONE : View.GONE
        ...
        flag 23 (0x18L): viewmodel.groupDetails.createdAt != null ? View.VISIBLE : View.GONE
    flag mapping end*/
    //end
}