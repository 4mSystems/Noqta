...
public class FragmentSplashBindingImpl extends FragmentSplashBinding implements te.app.notta.generated.callback.OnClickListener.Listener {
    ...
    private FragmentSplashBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback50 = new te.app.notta.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.notta.pages.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.notta.pages.splash.SplashViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewmodel((te.app.notta.pages.splash.SplashViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(te.app.notta.pages.splash.SplashViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.notta.pages.splash.SplashViewModel viewmodel = mViewmodel;

        if ((dirtyFlags & 0x7L) != 0) {

                // read UserHelper.getInstance(context).isFirst
                userHelperGetInstanceContextIsFirst = te.app.notta.utils.session.UserHelper.getInstance(getRoot().getContext()).getIsFirst();
    ...
    public static class OnCheckedChangeListenerImpl implements android.widget.RadioGroup.OnCheckedChangeListener{
        private te.app.notta.pages.splash.SplashViewModel value;
        public OnCheckedChangeListenerImpl setValue(te.app.notta.pages.splash.SplashViewModel value) {
            this.value = value;
