...
public class FragmentPointsBindingImpl extends FragmentPointsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.card_points, 3);
        sViewsWithIds.put(R.id.ic_gifts, 4);
        sViewsWithIds.put(R.id.tv_your_point1, 5);
        sViewsWithIds.put(R.id.tv_your_point2, 6);
        sViewsWithIds.put(R.id.tv_your_point3, 7);
    }
    // views
    @NonNull
