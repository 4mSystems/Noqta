...
public class FragmentCitiesBindingImpl extends FragmentCitiesBinding implements grand.app.aber_provider.generated.callback.OnClickListener.Listener {
    ...
    public FragmentCitiesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private FragmentCitiesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback80 = new grand.app.aber_provider.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.appCompatButtonNext.setOnClickListener(mCallback80);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        if (viewmodelJavaLangObjectNull) {
            ...
            viewmodel.action(grand.app.aber_provider.utils.Constants.HOME);
        }
    }
    // dirty flag
