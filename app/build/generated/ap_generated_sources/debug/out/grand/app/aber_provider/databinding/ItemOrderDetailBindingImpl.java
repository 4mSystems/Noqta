...
public class ItemOrderDetailBindingImpl extends ItemOrderDetailBinding implements grand.app.aber_provider.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_parts_name, 2);
        sViewsWithIds.put(R.id.btn_count, 3);
        sViewsWithIds.put(R.id.tv_parts_price, 4);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2L) != 0) {
            ...
            this.mboundView0.setOnClickListener(mCallback59);
        }
    }
