...
public class FragmentFollowUpOrdersBindingImpl extends FragmentFollowUpOrdersBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.follow_img_map, 1);
    }
    // views
    @NonNull
    ...
    public FragmentFollowUpOrdersBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private FragmentFollowUpOrdersBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
