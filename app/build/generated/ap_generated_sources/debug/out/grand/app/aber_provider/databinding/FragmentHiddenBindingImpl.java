...
public class FragmentHiddenBindingImpl extends FragmentHiddenBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.input_hidden_type, 6);
        sViewsWithIds.put(R.id.input_hidden_color, 7);
        sViewsWithIds.put(R.id.input_hidden_percentage, 8);
    ...
    public FragmentHiddenBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private FragmentHiddenBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
