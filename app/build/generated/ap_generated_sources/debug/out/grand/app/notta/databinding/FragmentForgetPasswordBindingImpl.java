...
public class FragmentForgetPasswordBindingImpl extends FragmentForgetPasswordBinding implements grand.app.notta.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener mboundView2androidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewmodel.request
            grand.app.notta.pages.auth.models.ForgetPasswordRequest viewmodelRequest = null;
            // viewmodel.request.phone
            java.lang.String viewmodelRequestPhone = null;
            // viewmodel
            grand.app.notta.pages.auth.forgetPassword.ForgetPasswordViewModel viewmodel = mViewmodel;
    ...
    private FragmentForgetPasswordBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[5]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[10]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[8]
            , (grand.app.notta.customViews.views.CustomTextViewRegular) bindings[9]
            );
        ...
        setRootTag(root);
        // listeners
        mCallback13 = new grand.app.notta.generated.callback.OnClickListener(this, 3);
        mCallback11 = new grand.app.notta.generated.callback.OnClickListener(this, 1);
        mCallback12 = new grand.app.notta.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((grand.app.notta.pages.auth.forgetPassword.ForgetPasswordViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable grand.app.notta.pages.auth.forgetPassword.ForgetPasswordViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodel((grand.app.notta.pages.auth.forgetPassword.ForgetPasswordViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodel(grand.app.notta.pages.auth.forgetPassword.ForgetPasswordViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
