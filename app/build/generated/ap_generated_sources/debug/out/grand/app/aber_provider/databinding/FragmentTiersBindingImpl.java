...
public class FragmentTiersBindingImpl extends FragmentTiersBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ic_car_tier_desc, 9);
        sViewsWithIds.put(R.id.input_tier_type, 10);
        sViewsWithIds.put(R.id.input_tier_desc, 11);
        sViewsWithIds.put(R.id.img_container, 12);
        sViewsWithIds.put(R.id.tv_upload, 13);
        sViewsWithIds.put(R.id.input_message, 14);
        sViewsWithIds.put(R.id.search_location, 15);
        sViewsWithIds.put(R.id.pic_time, 16);
    ...
    public FragmentTiersBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 18, sIncludes, sViewsWithIds));
    }
    private FragmentTiersBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (androidx.appcompat.widget.AppCompatButton) bindings[2]
            , (com.google.android.material.checkbox.MaterialCheckBox) bindings[17]
