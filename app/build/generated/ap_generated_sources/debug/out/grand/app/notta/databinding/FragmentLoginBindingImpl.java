...
public class FragmentLoginBindingImpl extends FragmentLoginBinding implements grand.app.notta.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener mboundView1androidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            grand.app.notta.pages.auth.models.LoginRequest viewmodelLoginRequest = null;
            // viewmodel
            grand.app.notta.pages.auth.login.LoginViewModel viewmodel = mViewmodel;
    ...
    private FragmentLoginBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[9]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[10]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[6]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[7]
            , (com.google.android.material.progressindicator.CircularProgressIndicator) bindings[5]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[3]
            );
        ...
        setRootTag(root);
        // listeners
        mCallback8 = new grand.app.notta.generated.callback.OnClickListener(this, 2);
        mCallback10 = new grand.app.notta.generated.callback.OnClickListener(this, 4);
        mCallback9 = new grand.app.notta.generated.callback.OnClickListener(this, 3);
        mCallback7 = new grand.app.notta.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((grand.app.notta.pages.auth.login.LoginViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable grand.app.notta.pages.auth.login.LoginViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodel((grand.app.notta.pages.auth.login.LoginViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodel(grand.app.notta.pages.auth.login.LoginViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
