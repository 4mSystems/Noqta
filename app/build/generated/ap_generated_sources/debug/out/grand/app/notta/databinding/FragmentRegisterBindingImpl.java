...
public class FragmentRegisterBindingImpl extends FragmentRegisterBinding implements grand.app.notta.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener autoandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewmodel
            grand.app.notta.pages.auth.register.RegisterViewModel viewmodel = mViewmodel;
    ...
    private FragmentRegisterBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            ...
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[16]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[17]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[13]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[14]
        ...
        setRootTag(root);
        // listeners
        mCallback16 = new grand.app.notta.generated.callback.OnClickListener(this, 1);
        mCallback17 = new grand.app.notta.generated.callback.OnClickListener(this, 2);
        mCallback18 = new grand.app.notta.generated.callback.OnClickListener(this, 3);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((grand.app.notta.pages.auth.register.RegisterViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable grand.app.notta.pages.auth.register.RegisterViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewmodel((grand.app.notta.pages.auth.register.RegisterViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(grand.app.notta.pages.auth.register.RegisterViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
