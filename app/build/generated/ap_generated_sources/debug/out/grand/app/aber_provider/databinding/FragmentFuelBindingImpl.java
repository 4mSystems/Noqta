...
public class FragmentFuelBindingImpl extends FragmentFuelBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.input_fuel_types, 4);
        sViewsWithIds.put(R.id.input_fuel_categories, 5);
        sViewsWithIds.put(R.id.input_message, 6);
        sViewsWithIds.put(R.id.info_card, 7);
        sViewsWithIds.put(R.id.tv_note, 8);
        sViewsWithIds.put(R.id.search_location, 9);
        sViewsWithIds.put(R.id.pic_time, 10);
    ...
    public FragmentFuelBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private FragmentFuelBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (androidx.appcompat.widget.AppCompatButton) bindings[1]
            , (com.google.android.material.checkbox.MaterialCheckBox) bindings[11]
