...
public class FragmentAberBoxBindingImpl extends FragmentAberBoxBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.input_message, 4);
        sViewsWithIds.put(R.id.search_location, 5);
        sViewsWithIds.put(R.id.pic_time, 6);
    ...
    public FragmentAberBoxBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private FragmentAberBoxBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
