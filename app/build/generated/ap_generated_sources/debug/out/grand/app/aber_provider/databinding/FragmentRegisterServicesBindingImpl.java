...
public class FragmentRegisterServicesBindingImpl extends FragmentRegisterServicesBinding implements grand.app.aber_provider.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.progress_percentage, 4);
        sViewsWithIds.put(R.id.tv_percentage, 5);
        sViewsWithIds.put(R.id.card_personal_info, 6);
