...
public class FragmentConfirmCodeBindingImpl extends FragmentConfirmCodeBinding implements grand.app.notta.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener pinValidateandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewmodel.request
            grand.app.notta.pages.auth.models.ConfirmCodeRequest viewmodelRequest = null;
            // viewmodel.request.code
            java.lang.String viewmodelRequestCode = null;
            // viewmodel
            grand.app.notta.pages.auth.confirmCode.ConfirmViewModel viewmodel = mViewmodel;
    ...
    private FragmentConfirmCodeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (grand.app.notta.customViews.views.CustomTextViewRegular) bindings[3]
            , (grand.app.notta.customViews.views.CustomTextViewMedium) bindings[11]
        ...
        setRootTag(root);
        // listeners
        mCallback2 = new grand.app.notta.generated.callback.OnClickListener(this, 2);
        mCallback1 = new grand.app.notta.generated.callback.OnClickListener(this, 1);
        mCallback3 = new grand.app.notta.generated.callback.OnClickListener(this, 3);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((grand.app.notta.pages.auth.confirmCode.ConfirmViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable grand.app.notta.pages.auth.confirmCode.ConfirmViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodel((grand.app.notta.pages.auth.confirmCode.ConfirmViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodel(grand.app.notta.pages.auth.confirmCode.ConfirmViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        grand.app.notta.PassingObject viewmodelPassingObject = null;
        grand.app.notta.pages.auth.models.ConfirmCodeRequest viewmodelRequest = null;
