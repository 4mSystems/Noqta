...
public class MenuBindingImpl extends MenuBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.menuViewModel == variableId) {
            setMenuViewModel((grand.app.notta.customViews.views.MenuViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMenuViewModel(@Nullable grand.app.notta.customViews.views.MenuViewModel MenuViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeMenuViewModel((grand.app.notta.customViews.views.MenuViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeMenuViewModel(grand.app.notta.customViews.views.MenuViewModel MenuViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
