...
public class FragmentOpenCarBindingImpl extends FragmentOpenCarBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.input_car_motor_number, 9);
        sViewsWithIds.put(R.id.input_car_license, 10);
        sViewsWithIds.put(R.id.input_message, 11);
        sViewsWithIds.put(R.id.search_location, 12);
        sViewsWithIds.put(R.id.pic_time, 13);
    ...
    public FragmentOpenCarBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private FragmentOpenCarBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (androidx.appcompat.widget.AppCompatButton) bindings[2]
            , (com.google.android.material.checkbox.MaterialCheckBox) bindings[14]
