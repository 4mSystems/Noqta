...
public class FragmentWashBindingImpl extends FragmentWashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.info_card, 6);
        sViewsWithIds.put(R.id.rc_extra_services, 7);
        sViewsWithIds.put(R.id.input_message, 8);
    ...
    public FragmentWashBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private FragmentWashBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
