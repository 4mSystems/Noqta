...
public class FragmentBatteriesBindingImpl extends FragmentBatteriesBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.input_car_types, 6);
        sViewsWithIds.put(R.id.input_car_categories, 7);
        sViewsWithIds.put(R.id.input_car_models, 8);
        sViewsWithIds.put(R.id.input_battery_type, 9);
        sViewsWithIds.put(R.id.input_battery_size, 10);
        sViewsWithIds.put(R.id.img_container, 11);
        sViewsWithIds.put(R.id.tv_upload, 12);
        sViewsWithIds.put(R.id.input_message, 13);
        sViewsWithIds.put(R.id.search_location, 14);
        sViewsWithIds.put(R.id.pic_time, 15);
    ...
    public FragmentBatteriesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private FragmentBatteriesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (androidx.appcompat.widget.AppCompatButton) bindings[2]
            , (com.google.android.material.checkbox.MaterialCheckBox) bindings[16]
