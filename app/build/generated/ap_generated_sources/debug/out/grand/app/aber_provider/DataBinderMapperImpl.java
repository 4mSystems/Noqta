...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FRAGMENTCOUNTRIES = 11;
  ...
  private static final int LAYOUT_FRAGMENTMYACCOUNTSETTINGS = 17;

  private static final int LAYOUT_FRAGMENTNOTIFICATIONS = 18;

  private static final int LAYOUT_FRAGMENTONBOARD = 19;

  private static final int LAYOUT_FRAGMENTPACKAGES = 20;

  private static final int LAYOUT_FRAGMENTREGISTER = 21;

  private static final int LAYOUT_FRAGMENTREGISTERDOCUMENTS = 22;

  private static final int LAYOUT_FRAGMENTREGISTERSERVICES = 23;

  private static final int LAYOUT_FRAGMENTSERVICESORDERS = 24;

  private static final int LAYOUT_FRAGMENTSOCIALMEDIA = 25;
  ...
  private static final int LAYOUT_ITEMCOUNTRY = 29;

  private static final int LAYOUT_ITEMEXTRASERVICES = 30;

  private static final int LAYOUT_ITEMFAVORITE = 31;

  private static final int LAYOUT_ITEMHOME = 32;

  private static final int LAYOUT_ITEMORDERCONFIRMED = 33;

  private static final int LAYOUT_ITEMORDERDETAIL = 34;

  private static final int LAYOUT_ITEMORDERSERVICE = 35;

  private static final int LAYOUT_ITEMPART = 36;

  private static final int LAYOUT_ITEMPARTSERVICE = 37;

  private static final int LAYOUT_ITEMREQUIREDSERVICE = 38;

  private static final int LAYOUT_ITEMSALEDESC = 39;

  private static final int LAYOUT_ITEMSEARCH = 40;

  private static final int LAYOUT_ITEMSERVICE = 41;

  private static final int LAYOUT_ITEMSIZE = 42;

  private static final int LAYOUT_ITEMSOCIAL = 43;

  private static final int LAYOUT_ITEMWALLETHISTORY = 44;

  private static final int LAYOUT_LAYOUTACTIONBARBACK = 45;

  private static final int LAYOUT_LAYOUTACTIONBARHOME = 46;

  private static final int LAYOUT_MENU = 47;

  private static final int LAYOUT_NOTIFYITEM = 48;
  ...
  private static class InnerBrLookup {
    static final SparseArray<String> sKeys = new SparseArray<String>(43);
    ...
    static {
      ...
      sKeys.put(14, "mainComment");
      sKeys.put(15, "mainData");
      sKeys.put(16, "mainFollowersData");
      sKeys.put(17, "mapAddressViewModel");
      sKeys.put(18, "memberCertificatesAdapter");
      sKeys.put(19, "menuViewModel");
      sKeys.put(20, "message");
      sKeys.put(21, "notificationsAdapter");
      sKeys.put(22, "notificationsData");
      sKeys.put(23, "notifyItemViewModels");
      sKeys.put(24, "notifyViewModel");
      sKeys.put(25, "onBoardAdapter");
      sKeys.put(26, "onBoardViewModels");
      sKeys.put(27, "orderImages");
      sKeys.put(28, "passingObject");
      sKeys.put(29, "peopleData");
      sKeys.put(30, "postData");
      sKeys.put(31, "postsAdapter");
      sKeys.put(32, "questionedPostsAdapter");
      sKeys.put(33, "raiseWalletRequest");
      sKeys.put(34, "reactType");
      sKeys.put(35, "reportData");
      sKeys.put(36, "reportReasonsAdapter");
      sKeys.put(37, "userCertificatesItem");
      sKeys.put(38, "userDocuments");
      sKeys.put(39, "userProfile");
      sKeys.put(40, "viewModel");
      sKeys.put(41, "viewmodel");
      sKeys.put(42, "walletHistoryItem");
    }
  }
