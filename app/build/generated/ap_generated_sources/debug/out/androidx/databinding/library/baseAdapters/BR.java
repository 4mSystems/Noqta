...
public class BR {
  ...
  public static final int countriesAdapter = 5;

  public static final int countriesData = 6;

  public static final int createCommentRequest = 7;

  public static final int fileObject = 8;

  public static final int followersAdapter = 9;

  public static final int followersResponse = 10;

  public static final int historyWalletData = 11;

  public static final int itemOrderViewModel = 12;

  public static final int itemPostViewModel = 13;

  public static final int itemViewModel = 14;

  public static final int itemWalletViewModel = 15;
  ...
  public static final int notificationsAdapter = 22;

  public static final int notificationsData = 23;

  public static final int notifyItemViewModels = 24;

  public static final int notifyViewModel = 25;
