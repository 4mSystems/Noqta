...
public class ItemSocialBindingImpl extends ItemSocialBinding implements grand.app.aber_provider.generated.callback.OnClickListener.Listener {
    ...
    private ItemSocialBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback87 = new grand.app.aber_provider.generated.callback.OnClickListener(this, 2);
        mCallback86 = new grand.app.aber_provider.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.mboundView0.setOnClickListener(mCallback86);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1
