...
public class FragmentOrderDetailsBindingImpl extends FragmentOrderDetailsBinding implements grand.app.aber_provider.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.searchContainer, 32);
        sViewsWithIds.put(R.id.textView2, 33);
        sViewsWithIds.put(R.id.card_personal_info, 34);
        sViewsWithIds.put(R.id.header, 35);
        sViewsWithIds.put(R.id.card_service, 36);
        sViewsWithIds.put(R.id.tv_service_type, 37);
        sViewsWithIds.put(R.id.card_time, 38);
        sViewsWithIds.put(R.id.item_time_warning, 39);
        sViewsWithIds.put(R.id.tv_delivery_time, 40);
        sViewsWithIds.put(R.id.br, 41);
        sViewsWithIds.put(R.id.required_service_type, 42);
        sViewsWithIds.put(R.id.car_desc, 43);
        sViewsWithIds.put(R.id.car_image_desc, 44);
        sViewsWithIds.put(R.id.car_type, 45);
        sViewsWithIds.put(R.id.car_cat, 46);
        sViewsWithIds.put(R.id.ca_year, 47);
        sViewsWithIds.put(R.id.other_service, 48);
        sViewsWithIds.put(R.id.extra_service, 49);
        sViewsWithIds.put(R.id.card_invoice, 50);
        sViewsWithIds.put(R.id.tv_services_cost, 51);
        sViewsWithIds.put(R.id.v_services_price, 52);
        sViewsWithIds.put(R.id.tv_services_extra_cost, 53);
        sViewsWithIds.put(R.id.v_services__extra_price, 54);
        sViewsWithIds.put(R.id.tv_delivery_cost, 55);
        sViewsWithIds.put(R.id.v_delivery_price, 56);
        sViewsWithIds.put(R.id.tv_eme_cost, 57);
        sViewsWithIds.put(R.id.v_eme_price, 58);
        sViewsWithIds.put(R.id.tv_total, 59);
        sViewsWithIds.put(R.id.card_desc, 60);
        sViewsWithIds.put(R.id.tv_service_desc, 61);
        sViewsWithIds.put(R.id.br2, 62);
    }
    // views
    @NonNull
    ...
    private FragmentOrderDetailsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (androidx.constraintlayout.widget.Barrier) bindings[41]
            ...
            , (grand.app.aber_provider.customViews.views.CustomTextViewMedium) bindings[49]
            ...
            , (com.google.android.material.progressindicator.CircularProgressIndicator) bindings[31]
            ...
            , (grand.app.aber_provider.customViews.views.CustomTextViewMedium) bindings[61]
            ...
            , (grand.app.aber_provider.customViews.views.CustomTextViewRegular) bindings[51]
            , (grand.app.aber_provider.customViews.views.CustomTextViewRegular) bindings[53]
        ...
        setRootTag(root);
        // listeners
        mCallback67 = new grand.app.aber_provider.generated.callback.OnClickListener(this, 2);
        mCallback68 = new grand.app.aber_provider.generated.callback.OnClickListener(this, 3);
        mCallback66 = new grand.app.aber_provider.generated.callback.OnClickListener(this, 1);
        mCallback69 = new grand.app.aber_provider.generated.callback.OnClickListener(this, 4);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.btnAccept.setOnClickListener(mCallback67);
            this.btnReject.setOnClickListener(mCallback68);
            this.locationImage.setOnClickListener(mCallback66);
            this.status.setOnClickListener(mCallback69);
        }
        if ((dirtyFlags & 0x43L) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 9 (0xaL): viewModel.orderDetailsMain.mainService.id == 19 ? @android:string/license_civil_image_hint : @android:string/battery_image
        flag 10 (0xbL): viewModel.orderDetailsMain.mainService.id == 19 ? @android:string/license_civil_image_hint : @android:string/battery_image
        flag 11 (0xcL): viewModel.orderDetailsMain.status == 0 ? View.VISIBLE : View.GONE
        flag 12 (0xdL): viewModel.orderDetailsMain.status == 0 ? View.VISIBLE : View.GONE
        flag 13 (0xeL): TextUtils.isEmpty(viewModel.message) ? true : viewModel.message.equals(Constants.HIDE_PROGRESS) ? viewModel.orderDetailsMain.canceled != 1 : false ? true : false
        flag 14 (0xfL): TextUtils.isEmpty(viewModel.message) ? true : viewModel.message.equals(Constants.HIDE_PROGRESS) ? viewModel.orderDetailsMain.canceled != 1 : false ? true : false
        flag 15 (0x10L): viewModel.orderDetailsMain.mainService.id == 9 ? @android:string/tier_image : viewModel.orderDetailsMain.mainService.id == 19 ? @android:string/license_civil_image_hint : @android:string/battery_image
        flag 16 (0x11L): viewModel.orderDetailsMain.mainService.id == 9 ? @android:string/tier_image : viewModel.orderDetailsMain.mainService.id == 19 ? @android:string/license_civil_image_hint : @android:string/battery_image
        flag 17 (0x12L): viewModel.orderDetailsMain.childServices.size() == 0 ? View.GONE : View.VISIBLE
        flag 18 (0x13L): viewModel.orderDetailsMain.childServices.size() == 0 ? View.GONE : View.VISIBLE
        flag 19 (0x14L): !TextUtils.isEmpty(viewModel.orderDetailsMain.image) ? View.VISIBLE : View.GONE
        flag 20 (0x15L): !TextUtils.isEmpty(viewModel.orderDetailsMain.image) ? View.VISIBLE : View.GONE
        ...
        flag 23 (0x18L): viewModel.orderDetailsMain.status != 0 ? viewModel.orderDetailsMain.status != 4 : false
        flag 24 (0x19L): viewModel.orderDetailsMain.status != 0 ? viewModel.orderDetailsMain.status != 4 : false
        flag 25 (0x1aL): viewModel.orderDetailsMain.user != null ? View.VISIBLE : View.GONE
        flag 26 (0x1bL): viewModel.orderDetailsMain.user != null ? View.VISIBLE : View.GONE
        flag 27 (0x1cL): viewModel.orderDetailsMain.status != 0 ? viewModel.orderDetailsMain.status != 4 : false ? View.VISIBLE : View.GONE
        flag 28 (0x1dL): viewModel.orderDetailsMain.status != 0 ? viewModel.orderDetailsMain.status != 4 : false ? View.VISIBLE : View.GONE
        flag 29 (0x1eL): TextUtils.isEmpty(viewModel.message) ? true : viewModel.message.equals(Constants.HIDE_PROGRESS) ? viewModel.orderDetailsMain.canceled != 1 : false
        flag 30 (0x1fL): TextUtils.isEmpty(viewModel.message) ? true : viewModel.message.equals(Constants.HIDE_PROGRESS) ? viewModel.orderDetailsMain.canceled != 1 : false
        flag 31 (0x20L): viewModel.orderDetailsMain.vehicle != null ? View.VISIBLE : View.GONE
        flag 32 (0x21L): viewModel.orderDetailsMain.vehicle != null ? View.VISIBLE : View.GONE
        flag 33 (0x22L): viewModel.orderDetailsMain.isEmergency == 1 ? @android:string/emergency_services : viewModel.orderDetailsMain.scheduledAt
        flag 34 (0x23L): viewModel.orderDetailsMain.isEmergency == 1 ? @android:string/emergency_services : viewModel.orderDetailsMain.scheduledAt
        flag 35 (0x24L): viewModel.orderDetailsMain.subServices.size() > 0 ? View.VISIBLE : View.GONE
        flag 36 (0x25L): viewModel.orderDetailsMain.subServices.size() > 0 ? View.VISIBLE : View.GONE
        flag 37 (0x26L): viewModel.orderDetailsMain.extraServices.size() == 0 ? View.GONE : View.VISIBLE
        flag 38 (0x27L): viewModel.orderDetailsMain.extraServices.size() == 0 ? View.GONE : View.VISIBLE
        flag 39 (0x28L): TextUtils.isEmpty(viewModel.message) ? true : viewModel.message.equals(Constants.HIDE_PROGRESS)
        flag 40 (0x29L): TextUtils.isEmpty(viewModel.message) ? true : viewModel.message.equals(Constants.HIDE_PROGRESS)
    flag mapping end*/
    //end
}