...
public class FragmentPointsBindingImpl extends FragmentPointsBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentPointsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback38 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.points.adapters.PointsAdapter viewmodelPointsAdapter = null;
        te.app.nottaa.pages.points.models.students.StudentMainPoints viewmodelStudentMainPoints = null;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.getItemsV2Binding(this.rcPoints, viewmodelPointsAdapter, "1", "1");
        }
        if ((dirtyFlags & 0xbL) != 0) {
            // api target 1
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        if (viewmodelJavaLangObjectNull) {
            ...
            viewmodel.action(te.app.nottaa.utils.Constants.ADD_GIFT);
        }
    }
    // dirty flag
