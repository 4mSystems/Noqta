...
public class ItemStudentInviteBindingImpl extends ItemStudentInviteBinding implements te.app.nottaa.generated.callback.OnCheckedChangeListener.Listener {
    ...
    private ItemStudentInviteBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback90 = new te.app.nottaa.generated.callback.OnCheckedChangeListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((te.app.nottaa.pages.teacher.viewModels.ItemStudentInviteViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable te.app.nottaa.pages.teacher.viewModels.ItemStudentInviteViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModel((te.app.nottaa.pages.teacher.viewModels.ItemStudentInviteViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModel(te.app.nottaa.pages.teacher.viewModels.ItemStudentInviteViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.auth.models.UserData viewModelStudent = null;
        java.lang.String viewModelStudentImage = null;
        java.lang.String viewModelStudentName = null;
        te.app.nottaa.pages.teacher.viewModels.ItemStudentInviteViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.loadImage(this.tvMember, viewModelStudentImage);
