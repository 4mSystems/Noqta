...
public class NotifyItemBindingImpl extends NotifyItemBinding implements te.app.notta.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.notifyItemViewModels == variableId) {
            setNotifyItemViewModels((te.app.notta.pages.notifications.itemViewModels.NotificationsItemViewModels) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setNotifyItemViewModels(@Nullable te.app.notta.pages.notifications.itemViewModels.NotificationsItemViewModels NotifyItemViewModels) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeNotifyItemViewModels((te.app.notta.pages.notifications.itemViewModels.NotificationsItemViewModels) object, fieldId);
        }
        return false;
    }
    private boolean onChangeNotifyItemViewModels(te.app.notta.pages.notifications.itemViewModels.NotificationsItemViewModels NotifyItemViewModels, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.notta.pages.notifications.itemViewModels.NotificationsItemViewModels notifyItemViewModels = mNotifyItemViewModels;
        java.lang.String notifyItemViewModelsNotificationsDataBody = null;
        te.app.notta.pages.notifications.models.NotificationsData notifyItemViewModelsNotificationsData = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            te.app.notta.base.ApplicationBinding.loadFullImage(this.img, notifyItemViewModelsNotificationsDataImage);
