...
public class GivePointsSheetBindingImpl extends GivePointsSheetBinding  {
    ...
    private GivePointsSheetBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (te.app.nottaa.customViews.views.IncrementalView) bindings[5]
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2aL) != 0) {
            ...
            te.app.nottaa.customViews.views.IncrementalView.getValue(this.incrementalViewStudentCount, viewModelAddAnswerRequestPoints);
    ...
    public static class OnTextChangedImpl implements androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged{
        private te.app.nottaa.pages.addAnswer.viewModels.AddAnswerViewModel value;
        public OnTextChangedImpl setValue(te.app.nottaa.pages.addAnswer.viewModels.AddAnswerViewModel value) {
            this.value = value;
