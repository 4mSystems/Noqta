...
public class FragmentOnboardBindingImpl extends FragmentOnboardBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentOnboardBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback5 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback4 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.onBoardViewModels == variableId) {
            setOnBoardViewModels((te.app.nottaa.pages.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setOnBoardViewModels(@Nullable te.app.nottaa.pages.splash.SplashViewModel OnBoardViewModels) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeOnBoardViewModels((te.app.nottaa.pages.splash.SplashViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeOnBoardViewModels(te.app.nottaa.pages.splash.SplashViewModel OnBoardViewModels, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.onBoard.OnBoardAdapter onBoardViewModelsOnBoardAdapter = null;
        int onBoardViewModelsOnBoardAdapterPagerListSizeInt0ViewVISIBLEViewGONE = 0;
        java.util.List<te.app.nottaa.pages.onBoard.models.OnBoard> onBoardViewModelsOnBoardAdapterPagerList = null;
        te.app.nottaa.pages.splash.SplashViewModel onBoardViewModels = mOnBoardViewModels;
        ...
        switch(sourceId) {
            case 2: {
                ...
                if (onBoardViewModelsJavaLangObjectNull) {
                    ...
                    onBoardViewModels.action(te.app.nottaa.utils.Constants.NEXT);
                }
                break;
            }
            case 1: {
                ...
                if (onBoardViewModelsJavaLangObjectNull) {
                    ...
                    onBoardViewModels.action(te.app.nottaa.utils.Constants.LOGIN);
                }
                break;
            }
        }
