...
public class FragmentStudentTasksBindingImpl extends FragmentStudentTasksBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentStudentTasksBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback67 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.getItemsV2Binding(this.rcMembers, viewmodelTasksAdapter, "1", "1");
        }
        if ((dirtyFlags & 0x16L) != 0) {
            // api target 1
