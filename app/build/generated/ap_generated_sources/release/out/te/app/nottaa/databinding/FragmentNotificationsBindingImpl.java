...
public class FragmentNotificationsBindingImpl extends FragmentNotificationsBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentNotificationsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback27 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.notifyViewModel == variableId) {
            setNotifyViewModel((te.app.nottaa.pages.notifications.viewModels.NotificationsViewModels) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setNotifyViewModel(@Nullable te.app.nottaa.pages.notifications.viewModels.NotificationsViewModels NotifyViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeNotifyViewModel((te.app.nottaa.pages.notifications.viewModels.NotificationsViewModels) object, fieldId);
            case 1 :
                return onChangeNotifyViewModelSearchProgressVisible((androidx.databinding.ObservableBoolean) object, fieldId);
        }
        return false;
    }
    private boolean onChangeNotifyViewModel(te.app.nottaa.pages.notifications.viewModels.NotificationsViewModels NotifyViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.notifications.viewModels.NotificationsViewModels notifyViewModel = mNotifyViewModel;
        java.util.List<te.app.nottaa.pages.notifications.models.NotificationsData> notifyViewModelNotificationsAdapterNotificationsDataList = null;
        ...
        te.app.nottaa.pages.notifications.adapters.NotificationsAdapter notifyViewModelNotificationsAdapter = null;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.getItemsV2Binding(this.rcNotifications, notifyViewModelNotificationsAdapter, "1", "1");
        }
