...
public class FragmentLoginBindingImpl extends FragmentLoginBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener mboundView1androidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            te.app.nottaa.pages.auth.models.LoginRequest viewmodelLoginRequest = null;
            // viewmodel
            te.app.nottaa.pages.auth.login.LoginViewModel viewmodel = mViewmodel;
    ...
    private FragmentLoginBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[7]
        ...
        setRootTag(root);
        // listeners
        mCallback11 = new te.app.nottaa.generated.callback.OnClickListener(this, 3);
        mCallback12 = new te.app.nottaa.generated.callback.OnClickListener(this, 4);
        mCallback10 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback9 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.nottaa.pages.auth.login.LoginViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.nottaa.pages.auth.login.LoginViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodel((te.app.nottaa.pages.auth.login.LoginViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodel(te.app.nottaa.pages.auth.login.LoginViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.btnPhone.setOnClickListener(mCallback10);
            this.loginNoAccount.setOnClickListener(mCallback11);
            this.loginNoAccountBold.setOnClickListener(mCallback12);
            ...
            this.tvLoginForget.setOnClickListener(mCallback9);
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView1, viewmodelLoginRequestEmail);
