...
public class FragmentMyGroupsBindingImpl extends FragmentMyGroupsBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentMyGroupsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback66 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.nottaa.pages.myGroups.viewModels.MyGroupsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.nottaa.pages.myGroups.viewModels.MyGroupsViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewmodel((te.app.nottaa.pages.myGroups.viewModels.MyGroupsViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(te.app.nottaa.pages.myGroups.viewModels.MyGroupsViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.myGroups.adapters.MyGroupsAdapter viewmodelGroupsAdapter = null;
        ...
        te.app.nottaa.pages.myGroups.viewModels.MyGroupsViewModel viewmodel = mViewmodel;
