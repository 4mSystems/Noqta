...
public class FragmentAddAnswerBindingImpl extends FragmentAddAnswerBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    @NonNull
    private final te.app.nottaa.customViews.views.CustomTextViewRegular mboundView12;
    @NonNull
    private final te.app.nottaa.customViews.views.CustomTextViewRegular mboundView13;
    @NonNull
    private final androidx.appcompat.widget.AppCompatImageView mboundView18;
    @NonNull
    private final te.app.nottaa.customViews.views.CustomTextViewRegular mboundView19;
    @NonNull
    private final te.app.nottaa.customViews.views.CustomTextViewMedium mboundView3;
    @NonNull
    ...
    private androidx.databinding.InverseBindingListener mboundView8androidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            te.app.nottaa.pages.addAnswer.models.AddAnswerRequest viewmodelAddAnswerRequest = null;
            // viewmodel.addAnswerRequest != null
            boolean viewmodelAddAnswerRequestJavaLangObjectNull = false;
            // viewmodel
            te.app.nottaa.pages.addAnswer.viewModels.AddAnswerViewModel viewmodel = mViewmodel;
    ...
    private FragmentAddAnswerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[27]
            , (te.app.nottaa.customViews.views.CustomTextViewRegular) bindings[4]
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[5]
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[9]
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[1]
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[23]
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[14]
        ...
        this.mboundView12 = (te.app.nottaa.customViews.views.CustomTextViewRegular) bindings[12];
        this.mboundView12.setTag(null);
        this.mboundView13 = (te.app.nottaa.customViews.views.CustomTextViewRegular) bindings[13];
        this.mboundView13.setTag(null);
        this.mboundView18 = (androidx.appcompat.widget.AppCompatImageView) bindings[18];
        this.mboundView18.setTag(null);
        this.mboundView19 = (te.app.nottaa.customViews.views.CustomTextViewRegular) bindings[19];
        this.mboundView19.setTag(null);
        this.mboundView3 = (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[3];
        ...
        setRootTag(root);
        // listeners
        mCallback79 = new te.app.nottaa.generated.callback.OnClickListener(this, 3);
        mCallback82 = new te.app.nottaa.generated.callback.OnClickListener(this, 6);
        mCallback83 = new te.app.nottaa.generated.callback.OnClickListener(this, 7);
        mCallback77 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        mCallback80 = new te.app.nottaa.generated.callback.OnClickListener(this, 4);
        mCallback78 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback81 = new te.app.nottaa.generated.callback.OnClickListener(this, 5);
        mCallback84 = new te.app.nottaa.generated.callback.OnClickListener(this, 8);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.nottaa.pages.addAnswer.viewModels.AddAnswerViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.nottaa.pages.addAnswer.viewModels.AddAnswerViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewmodel((te.app.nottaa.pages.addAnswer.viewModels.AddAnswerViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(te.app.nottaa.pages.addAnswer.viewModels.AddAnswerViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.addAnswer.models.TaskDetailsData viewmodelTaskDetailsData = null;
        ...
        te.app.nottaa.pages.addAnswer.adapters.TaskMediaAdapter viewmodelTaskMediaAdapter = null;
        ...
        te.app.nottaa.PassingObject viewmodelPassingObject = null;
        ...
        te.app.nottaa.pages.addAnswer.models.TaskFilesItem viewmodelTaskMediaAdapterFilesItemListGetInt0 = null;
        ...
        java.util.List<te.app.nottaa.pages.addAnswer.models.TaskFilesItem> viewmodelTaskMediaAdapterFilesItemList = null;
        ...
        te.app.nottaa.pages.addAnswer.models.TaskAnswersItem viewmodelTaskDetailsDataTaskAnswer = null;
        ...
        if ((dirtyFlags & 0x1ffL) != 0) {
            ...
            if ((dirtyFlags & 0x10eL) != 0) {
                    ...
                    if (viewmodelPassingObjectObject != null) {
                        ...
                        viewmodelPassingObjectObjectEqualsConstantsSHOWANSWERS = viewmodelPassingObjectObject.equals(te.app.nottaa.utils.Constants.SHOW_ANSWERS);
                    }
                ...
                if ((dirtyFlags & 0x10aL) != 0) {
                        ...
                        if (viewmodelPassingObjectObject != null) {
                            ...
                            viewmodelPassingObjectObjectEqualsConstantsAddANSWER = viewmodelPassingObjectObject.equals(te.app.nottaa.utils.Constants.Add_ANSWER);
                        }
                    if((dirtyFlags & 0x10aL) != 0) {
        ...
        if ((dirtyFlags & 0x112L) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.loadFullImage(this.mainImage, viewmodelTaskMediaAdapterItemCountInt0ViewmodelTaskMediaAdapterFilesItemListGetInt0FileJavaLangString);
            te.app.nottaa.base.ApplicationBinding.getItemsV2Binding(this.rcTaskMedia, viewmodelTaskMediaAdapter, "1", "2");
        }
        if ((dirtyFlags & 0x106L) != 0) {
            // api target 1
        ...
        switch(sourceId) {
            ...
            case 6: {
                ...
                if (viewmodelJavaLangObjectNull) {
                    ...
                    viewmodel.action(te.app.nottaa.utils.Constants.REMOVE_VIDEO);
                }
                break;
            }
            case 7: {
                ...
                if (viewmodelJavaLangObjectNull) {
                    ...
                    viewmodel.action(te.app.nottaa.utils.Constants.PLAY_VIDEO);
                }
                break;
            }
            case 1: {
