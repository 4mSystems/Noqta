...
public class FragmentProfileBindingImpl extends FragmentProfileBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentProfileBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback45 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback46 = new te.app.nottaa.generated.callback.OnClickListener(this, 3);
        mCallback44 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.settings.adapters.ProfileAdaptersAdapter viewmodelProfileAdaptersAdapter = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.getItemsV2Binding(this.mboundView6, viewmodelProfileAdaptersAdapter, "2", "1");
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1
