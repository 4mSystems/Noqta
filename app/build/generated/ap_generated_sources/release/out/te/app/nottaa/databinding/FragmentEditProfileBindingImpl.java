...
public class FragmentEditProfileBindingImpl extends FragmentEditProfileBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentEditProfileBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback15 = new te.app.nottaa.generated.callback.OnClickListener(this, 3);
        mCallback16 = new te.app.nottaa.generated.callback.OnClickListener(this, 4);
        mCallback17 = new te.app.nottaa.generated.callback.OnClickListener(this, 5);
        mCallback13 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        mCallback14 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x24L) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.loadImage(this.memberProfile, viewmodelUserDataImage);
        }
    }
        ...
        switch(sourceId) {
            ...
            case 4: {
                ...
                if (viewmodelJavaLangObjectNull) {
                    ...
                    viewmodel.action(te.app.nottaa.utils.Constants.CHANGE_PASSWORD);
                }
                break;
            }
            case 5: {
