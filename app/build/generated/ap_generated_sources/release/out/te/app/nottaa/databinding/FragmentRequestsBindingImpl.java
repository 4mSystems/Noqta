...
public class FragmentRequestsBindingImpl extends FragmentRequestsBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    public FragmentRequestsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    private FragmentRequestsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback8 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    private boolean onChangeViewmodel(te.app.nottaa.pages.groupDetails.viewModels.GroupDetailsViewModel Viewmodel, int fieldId) {
        ...
        else if (fieldId == BR.studentsRequestsAdapter) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
            return true;
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.groupDetails.adapters.GroupStudentsRequestsAdapter viewmodelStudentsRequestsAdapter = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                if (viewmodel != null) {
                    // read viewmodel.studentsRequestsAdapter
                    viewmodelStudentsRequestsAdapter = viewmodel.getStudentsRequestsAdapter();
                }
        }
        // batch finished
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.back.setOnClickListener(mCallback8);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1

            te.app.nottaa.base.ApplicationBinding.getItemsV2Binding(this.rcMembers, viewmodelStudentsRequestsAdapter, "1", "1");
        }
    }
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): viewmodel.studentsRequestsAdapter
        flag 2 (0x3L): null
    flag mapping end*/
    //end
}