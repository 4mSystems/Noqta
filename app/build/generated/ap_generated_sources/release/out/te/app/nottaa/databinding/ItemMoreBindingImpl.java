...
public class ItemMoreBindingImpl extends ItemMoreBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private ItemMoreBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback53 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.loadImage(this.icon, viewModelProfileItemIcon);
