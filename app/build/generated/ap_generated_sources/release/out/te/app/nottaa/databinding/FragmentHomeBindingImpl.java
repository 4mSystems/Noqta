...
public class FragmentHomeBindingImpl extends FragmentHomeBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentHomeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[8]
        ...
        setRootTag(root);
        // listeners
        mCallback55 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback54 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.nottaa.pages.home.viewModels.HomeViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.nottaa.pages.home.viewModels.HomeViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewmodel((te.app.nottaa.pages.home.viewModels.HomeViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(te.app.nottaa.pages.home.viewModels.HomeViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.home.adapters.GroupsAdapter viewmodelGroupsAdapter = null;
        ...
        te.app.nottaa.pages.home.viewModels.HomeViewModel viewmodel = mViewmodel;
        ...
        if ((dirtyFlags & 0xeL) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.getItemsV2Binding(this.rcGroups, viewmodelGroupsAdapter, "1", "1");
        }
    }
    // Listener Stub Implementations
    public static class OnTextChangedImpl implements androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged{
        private te.app.nottaa.pages.home.viewModels.HomeViewModel value;
        public OnTextChangedImpl setValue(te.app.nottaa.pages.home.viewModels.HomeViewModel value) {
            this.value = value;
        ...
        switch(sourceId) {
            case 2: {
                ...
                if (viewmodelJavaLangObjectNull) {
                    ...
                    viewmodel.action(te.app.nottaa.utils.Constants.ADD_GROUP);
                }
                break;
            }
            case 1: {
                ...
                if (viewmodelJavaLangObjectNull) {
                    ...
                    viewmodel.action(te.app.nottaa.utils.Constants.NOTIFICATIONS);
                }
                break;
            }
        }
