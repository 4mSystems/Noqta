...
public class FragmentInviteStudentBindingImpl extends FragmentInviteStudentBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private FragmentInviteStudentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback89 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback88 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.teacher.adapters.InviteStudentsAdapter viewModelInviteStudentsAdapter = null;
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.btnClose.setOnClickListener(mCallback89);
            this.dialogHeader.setOnClickListener(mCallback88);
        }
        if ((dirtyFlags & 0xaL) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0xeL) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.getItemsV2Binding(this.rcStudents, viewModelInviteStudentsAdapter, "1", "1");
        }
    }
