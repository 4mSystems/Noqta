...
public class FragmentAddTaskBindingImpl extends FragmentAddTaskBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    @NonNull
    private final te.app.nottaa.customViews.views.CustomTextViewRegular mboundView10;
    @NonNull
    private final te.app.nottaa.customViews.views.CustomTextViewRegular mboundView11;
    @NonNull
    ...
    private androidx.databinding.InverseBindingListener autoandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            te.app.nottaa.pages.teacher.models.AddTaskRequest viewmodelAddTaskRequest = null;
            // viewmodel != null
            boolean viewmodelJavaLangObjectNull = false;
            // viewmodel.addTaskRequest.description
            java.lang.String viewmodelAddTaskRequestDescription = null;
            // viewmodel
            te.app.nottaa.pages.teacher.viewModels.AddTaskViewModel viewmodel = mViewmodel;
    ...
    private FragmentAddTaskBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 5
            ...
            , (te.app.nottaa.customViews.views.IncrementalView) bindings[8]
            ...
            , (te.app.nottaa.customViews.views.CustomTextViewMedium) bindings[22]
        ...
        this.mboundView10 = (te.app.nottaa.customViews.views.CustomTextViewRegular) bindings[10];
        this.mboundView10.setTag(null);
        this.mboundView11 = (te.app.nottaa.customViews.views.CustomTextViewRegular) bindings[11];
        ...
        setRootTag(root);
        // listeners
        mCallback30 = new te.app.nottaa.generated.callback.OnClickListener(this, 3);
        mCallback28 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        mCallback32 = new te.app.nottaa.generated.callback.OnClickListener(this, 5);
        mCallback31 = new te.app.nottaa.generated.callback.OnClickListener(this, 4);
        mCallback33 = new te.app.nottaa.generated.callback.OnClickListener(this, 6);
        mCallback29 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback34 = new te.app.nottaa.generated.callback.OnClickListener(this, 7);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.nottaa.pages.teacher.viewModels.AddTaskViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.nottaa.pages.teacher.viewModels.AddTaskViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 4 :
                return onChangeViewmodel((te.app.nottaa.pages.teacher.viewModels.AddTaskViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(te.app.nottaa.pages.teacher.viewModels.AddTaskViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x10L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x200L) != 0) {
            ...
            this.icCloudUpload.setOnClickListener(mCallback29);
            this.icCloudUploadVideo.setOnClickListener(mCallback32);
            this.mboundView10.setOnClickListener(mCallback30);
            this.mboundView11.setOnClickListener(mCallback31);
            this.mboundView14.setOnClickListener(mCallback33);
        ...
        if ((dirtyFlags & 0x230L) != 0) {
            ...
            te.app.nottaa.customViews.views.IncrementalView.getValue(this.incrementalViewStudentCount, viewmodelAddTaskRequestPoints);
    ...
    public static class OnTextChangedImpl implements androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged{
        private te.app.nottaa.pages.teacher.viewModels.AddTaskViewModel value;
        public OnTextChangedImpl setValue(te.app.nottaa.pages.teacher.viewModels.AddTaskViewModel value) {
            this.value = value;
