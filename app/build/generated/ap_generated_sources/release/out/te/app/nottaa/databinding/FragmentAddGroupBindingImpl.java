...
public class FragmentAddGroupBindingImpl extends FragmentAddGroupBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    @NonNull
    private final te.app.nottaa.customViews.views.FutureDateEditText mboundView13;
    @NonNull
    ...
    private androidx.databinding.InverseBindingListener autoandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            te.app.nottaa.pages.teacher.models.AddGroupRequest viewmodelGroupRequest = null;
            // viewmodel.groupRequest != null
            boolean viewmodelGroupRequestJavaLangObjectNull = false;
            // viewmodel
            te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel viewmodel = mViewmodel;
    ...
    private FragmentAddGroupBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6
            ...
            , (te.app.nottaa.customViews.views.IncrementalView) bindings[11]
        ...
        this.mboundView13 = (te.app.nottaa.customViews.views.FutureDateEditText) bindings[13];
        ...
        setRootTag(root);
        // listeners
        mCallback2 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback1 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 5 :
                return onChangeViewmodel((te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x20L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x160L) != 0) {
            ...
            te.app.nottaa.customViews.views.IncrementalView.getValue(this.incrementalViewStudentCount, viewmodelGroupRequestNoOfStudents);
            te.app.nottaa.customViews.views.IncrementalView.getValue(this.incrementalViewTasksCount, viewmodelGroupRequestNoOfTasks);
    ...
    public static class OnTextChangedImpl implements androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged{
        private te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel value;
        public OnTextChangedImpl setValue(te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel value) {
            this.value = value;
    ...
    public static class OnTextChangedImpl1 implements androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged{
        private te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel value;
        public OnTextChangedImpl1 setValue(te.app.nottaa.pages.teacher.viewModels.AddGroupViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
