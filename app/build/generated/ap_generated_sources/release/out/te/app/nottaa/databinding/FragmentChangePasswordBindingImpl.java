...
public class FragmentChangePasswordBindingImpl extends FragmentChangePasswordBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener mboundView3androidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewmodel
            te.app.nottaa.pages.auth.changePassword.ChangePasswordViewModel viewmodel = mViewmodel;
    ...
    private FragmentChangePasswordBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            ...
            , (te.app.nottaa.customViews.views.CustomTextViewRegular) bindings[13]
            );
        ...
        setRootTag(root);
        // listeners
        mCallback19 = new te.app.nottaa.generated.callback.OnClickListener(this, 2);
        mCallback18 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.nottaa.pages.auth.changePassword.ChangePasswordViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.nottaa.pages.auth.changePassword.ChangePasswordViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewmodel((te.app.nottaa.pages.auth.changePassword.ChangePasswordViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(te.app.nottaa.pages.auth.changePassword.ChangePasswordViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x20L) != 0) {
            ...
            this.back.setOnClickListener(mCallback18);
