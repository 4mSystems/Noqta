...
public class ItemTaskMediaBindingImpl extends ItemTaskMediaBinding implements te.app.nottaa.generated.callback.OnClickListener.Listener {
    ...
    private ItemTaskMediaBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback99 = new te.app.nottaa.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((te.app.nottaa.pages.addAnswer.viewModels.ItemTaskMediaViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable te.app.nottaa.pages.addAnswer.viewModels.ItemTaskMediaViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModel((te.app.nottaa.pages.addAnswer.viewModels.ItemTaskMediaViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModel(te.app.nottaa.pages.addAnswer.viewModels.ItemTaskMediaViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.nottaa.pages.addAnswer.models.TaskFilesItem viewModelTaskFilesItem = null;
        te.app.nottaa.pages.addAnswer.viewModels.ItemTaskMediaViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            te.app.nottaa.base.ApplicationBinding.loadFullImage(this.icUser, viewModelTaskFilesItemFile);
            this.mboundView2.setVisibility(viewModelTaskFilesItemTypeInt1ViewVISIBLEViewGONE);
        }
        if ((dirtyFlags & 0x4L) != 0) {
            // api target 1

            this.mboundView2.setOnClickListener(mCallback99);
        }
    }
