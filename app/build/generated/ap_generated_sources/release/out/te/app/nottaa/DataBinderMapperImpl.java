...
import te.app.nottaa.databinding.ActivityBaseBindingImpl;
import te.app.nottaa.databinding.ActivityExoPlayerBindingImpl;
import te.app.nottaa.databinding.ActivityMainBindingImpl;
import te.app.nottaa.databinding.DeleteSheetBindingImpl;
import te.app.nottaa.databinding.FragmentAboutBindingImpl;
import te.app.nottaa.databinding.FragmentAddAnswerBindingImpl;
import te.app.nottaa.databinding.FragmentAddGiftBindingImpl;
import te.app.nottaa.databinding.FragmentAddGroupBindingImpl;
import te.app.nottaa.databinding.FragmentAddTaskBindingImpl;
import te.app.nottaa.databinding.FragmentChangePasswordBindingImpl;
import te.app.nottaa.databinding.FragmentConfirmCodeBindingImpl;
import te.app.nottaa.databinding.FragmentContactBindingImpl;
import te.app.nottaa.databinding.FragmentEditProfileBindingImpl;
import te.app.nottaa.databinding.FragmentForgetPasswordBindingImpl;
import te.app.nottaa.databinding.FragmentGroupDetailsBindingImpl;
import te.app.nottaa.databinding.FragmentGroupMembersBindingImpl;
import te.app.nottaa.databinding.FragmentGroupStudentsBindingImpl;
import te.app.nottaa.databinding.FragmentHomeBindingImpl;
import te.app.nottaa.databinding.FragmentInviteStudentBindingImpl;
import te.app.nottaa.databinding.FragmentLangBindingImpl;
import te.app.nottaa.databinding.FragmentLoginBindingImpl;
import te.app.nottaa.databinding.FragmentMoreBindingImpl;
import te.app.nottaa.databinding.FragmentMyGroupsBindingImpl;
import te.app.nottaa.databinding.FragmentMyPointsBindingImpl;
import te.app.nottaa.databinding.FragmentNotificationsBindingImpl;
import te.app.nottaa.databinding.FragmentOnboardBindingImpl;
import te.app.nottaa.databinding.FragmentPointsBindingImpl;
import te.app.nottaa.databinding.FragmentProfileBindingImpl;
import te.app.nottaa.databinding.FragmentRegisterBindingImpl;
import te.app.nottaa.databinding.FragmentRequestsBindingImpl;
import te.app.nottaa.databinding.FragmentSplashBindingImpl;
import te.app.nottaa.databinding.FragmentStudentTasksBindingImpl;
import te.app.nottaa.databinding.FragmentTasksBindingImpl;
import te.app.nottaa.databinding.GivePointsSheetBindingImpl;
import te.app.nottaa.databinding.ItemHomeBindingImpl;
import te.app.nottaa.databinding.ItemHorMemberBindingImpl;
import te.app.nottaa.databinding.ItemMemberBindingImpl;
import te.app.nottaa.databinding.ItemMoreBindingImpl;
import te.app.nottaa.databinding.ItemMyGroupBindingImpl;
import te.app.nottaa.databinding.ItemPointsBindingImpl;
import te.app.nottaa.databinding.ItemProfileBindingImpl;
import te.app.nottaa.databinding.ItemRecentTaskBindingImpl;
import te.app.nottaa.databinding.ItemStudentInviteBindingImpl;
import te.app.nottaa.databinding.ItemStudentRequestBindingImpl;
import te.app.nottaa.databinding.ItemTaskMediaBindingImpl;
import te.app.nottaa.databinding.LayoutActionBarBackBindingImpl;
import te.app.nottaa.databinding.LayoutActionBarHomeBindingImpl;
import te.app.nottaa.databinding.LayoutGrandBindingImpl;
import te.app.nottaa.databinding.MenuBindingImpl;
import te.app.nottaa.databinding.NotifyItemBindingImpl;
import te.app.nottaa.databinding.SuccessSheetBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.activity_base, LAYOUT_ACTIVITYBASE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.activity_exo_player, LAYOUT_ACTIVITYEXOPLAYER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.activity_main, LAYOUT_ACTIVITYMAIN);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.delete_sheet, LAYOUT_DELETESHEET);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_about, LAYOUT_FRAGMENTABOUT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_add_answer, LAYOUT_FRAGMENTADDANSWER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_add_gift, LAYOUT_FRAGMENTADDGIFT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_add_group, LAYOUT_FRAGMENTADDGROUP);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_add_task, LAYOUT_FRAGMENTADDTASK);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_change_password, LAYOUT_FRAGMENTCHANGEPASSWORD);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_confirm_code, LAYOUT_FRAGMENTCONFIRMCODE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_contact, LAYOUT_FRAGMENTCONTACT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_edit_profile, LAYOUT_FRAGMENTEDITPROFILE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_forget_password, LAYOUT_FRAGMENTFORGETPASSWORD);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_group_details, LAYOUT_FRAGMENTGROUPDETAILS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_group_members, LAYOUT_FRAGMENTGROUPMEMBERS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_group_students, LAYOUT_FRAGMENTGROUPSTUDENTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_home, LAYOUT_FRAGMENTHOME);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_invite_student, LAYOUT_FRAGMENTINVITESTUDENT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_lang, LAYOUT_FRAGMENTLANG);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_login, LAYOUT_FRAGMENTLOGIN);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_more, LAYOUT_FRAGMENTMORE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_my_groups, LAYOUT_FRAGMENTMYGROUPS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_my_points, LAYOUT_FRAGMENTMYPOINTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_notifications, LAYOUT_FRAGMENTNOTIFICATIONS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_onboard, LAYOUT_FRAGMENTONBOARD);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_points, LAYOUT_FRAGMENTPOINTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_profile, LAYOUT_FRAGMENTPROFILE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_register, LAYOUT_FRAGMENTREGISTER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_requests, LAYOUT_FRAGMENTREQUESTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_splash, LAYOUT_FRAGMENTSPLASH);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_student_tasks, LAYOUT_FRAGMENTSTUDENTTASKS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.fragment_tasks, LAYOUT_FRAGMENTTASKS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.give_points_sheet, LAYOUT_GIVEPOINTSSHEET);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_home, LAYOUT_ITEMHOME);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_hor_member, LAYOUT_ITEMHORMEMBER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_member, LAYOUT_ITEMMEMBER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_more, LAYOUT_ITEMMORE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_my_group, LAYOUT_ITEMMYGROUP);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_points, LAYOUT_ITEMPOINTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_profile, LAYOUT_ITEMPROFILE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_recent_task, LAYOUT_ITEMRECENTTASK);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_student_invite, LAYOUT_ITEMSTUDENTINVITE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_student_request, LAYOUT_ITEMSTUDENTREQUEST);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.item_task_media, LAYOUT_ITEMTASKMEDIA);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.layout_action_bar_back, LAYOUT_LAYOUTACTIONBARBACK);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.layout_action_bar_home, LAYOUT_LAYOUTACTIONBARHOME);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.layout_grand, LAYOUT_LAYOUTGRAND);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.menu, LAYOUT_MENU);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.notify_item, LAYOUT_NOTIFYITEM);
    INTERNAL_LAYOUT_ID_LOOKUP.put(te.app.nottaa.R.layout.success_sheet, LAYOUT_SUCCESSSHEET);
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout/activity_base_0", te.app.nottaa.R.layout.activity_base);
      sKeys.put("layout/activity_exo_player_0", te.app.nottaa.R.layout.activity_exo_player);
      sKeys.put("layout/activity_main_0", te.app.nottaa.R.layout.activity_main);
      sKeys.put("layout/delete_sheet_0", te.app.nottaa.R.layout.delete_sheet);
      sKeys.put("layout/fragment_about_0", te.app.nottaa.R.layout.fragment_about);
      sKeys.put("layout/fragment_add_answer_0", te.app.nottaa.R.layout.fragment_add_answer);
      sKeys.put("layout/fragment_add_gift_0", te.app.nottaa.R.layout.fragment_add_gift);
      sKeys.put("layout/fragment_add_group_0", te.app.nottaa.R.layout.fragment_add_group);
      sKeys.put("layout/fragment_add_task_0", te.app.nottaa.R.layout.fragment_add_task);
      sKeys.put("layout/fragment_change_password_0", te.app.nottaa.R.layout.fragment_change_password);
      sKeys.put("layout/fragment_confirm_code_0", te.app.nottaa.R.layout.fragment_confirm_code);
      sKeys.put("layout/fragment_contact_0", te.app.nottaa.R.layout.fragment_contact);
      sKeys.put("layout/fragment_edit_profile_0", te.app.nottaa.R.layout.fragment_edit_profile);
      sKeys.put("layout/fragment_forget_password_0", te.app.nottaa.R.layout.fragment_forget_password);
      sKeys.put("layout/fragment_group_details_0", te.app.nottaa.R.layout.fragment_group_details);
      sKeys.put("layout/fragment_group_members_0", te.app.nottaa.R.layout.fragment_group_members);
      sKeys.put("layout/fragment_group_students_0", te.app.nottaa.R.layout.fragment_group_students);
      sKeys.put("layout/fragment_home_0", te.app.nottaa.R.layout.fragment_home);
      sKeys.put("layout/fragment_invite_student_0", te.app.nottaa.R.layout.fragment_invite_student);
      sKeys.put("layout/fragment_lang_0", te.app.nottaa.R.layout.fragment_lang);
      sKeys.put("layout/fragment_login_0", te.app.nottaa.R.layout.fragment_login);
      sKeys.put("layout/fragment_more_0", te.app.nottaa.R.layout.fragment_more);
      sKeys.put("layout/fragment_my_groups_0", te.app.nottaa.R.layout.fragment_my_groups);
      sKeys.put("layout/fragment_my_points_0", te.app.nottaa.R.layout.fragment_my_points);
      sKeys.put("layout/fragment_notifications_0", te.app.nottaa.R.layout.fragment_notifications);
      sKeys.put("layout/fragment_onboard_0", te.app.nottaa.R.layout.fragment_onboard);
      sKeys.put("layout/fragment_points_0", te.app.nottaa.R.layout.fragment_points);
      sKeys.put("layout/fragment_profile_0", te.app.nottaa.R.layout.fragment_profile);
      sKeys.put("layout/fragment_register_0", te.app.nottaa.R.layout.fragment_register);
      sKeys.put("layout/fragment_requests_0", te.app.nottaa.R.layout.fragment_requests);
      sKeys.put("layout/fragment_splash_0", te.app.nottaa.R.layout.fragment_splash);
      sKeys.put("layout/fragment_student_tasks_0", te.app.nottaa.R.layout.fragment_student_tasks);
      sKeys.put("layout/fragment_tasks_0", te.app.nottaa.R.layout.fragment_tasks);
      sKeys.put("layout/give_points_sheet_0", te.app.nottaa.R.layout.give_points_sheet);
      sKeys.put("layout/item_home_0", te.app.nottaa.R.layout.item_home);
      sKeys.put("layout/item_hor_member_0", te.app.nottaa.R.layout.item_hor_member);
      sKeys.put("layout/item_member_0", te.app.nottaa.R.layout.item_member);
      sKeys.put("layout/item_more_0", te.app.nottaa.R.layout.item_more);
      sKeys.put("layout/item_my_group_0", te.app.nottaa.R.layout.item_my_group);
      sKeys.put("layout/item_points_0", te.app.nottaa.R.layout.item_points);
      sKeys.put("layout/item_profile_0", te.app.nottaa.R.layout.item_profile);
      sKeys.put("layout/item_recent_task_0", te.app.nottaa.R.layout.item_recent_task);
      sKeys.put("layout/item_student_invite_0", te.app.nottaa.R.layout.item_student_invite);
      sKeys.put("layout/item_student_request_0", te.app.nottaa.R.layout.item_student_request);
      sKeys.put("layout/item_task_media_0", te.app.nottaa.R.layout.item_task_media);
      sKeys.put("layout/layout_action_bar_back_0", te.app.nottaa.R.layout.layout_action_bar_back);
      sKeys.put("layout/layout_action_bar_home_0", te.app.nottaa.R.layout.layout_action_bar_home);
      sKeys.put("layout/layout_grand_0", te.app.nottaa.R.layout.layout_grand);
      sKeys.put("layout/menu_0", te.app.nottaa.R.layout.menu);
      sKeys.put("layout/notify_item_0", te.app.nottaa.R.layout.notify_item);
      sKeys.put("layout/success_sheet_0", te.app.nottaa.R.layout.success_sheet);
    }
  }
}
